...
public class QuizCardBuilder {
    ...
    // Inner class
    // Triggered when user hits 'Next Card' button; means the user wants to store that card in the list and start a
    // new card
    ...
    private void saveFile(File file) {
        try {
            ...
            System.out.println("Error: Could not write cardList");
            ex.printStackTrace();
        }
    }
}
